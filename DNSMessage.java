...
public class DNSMessage {
    // I use this to define the maximum length for a DNS message over UDP, which is 512 bytes.
    ...
    // track the next byte, read from the buffer when building a request message
